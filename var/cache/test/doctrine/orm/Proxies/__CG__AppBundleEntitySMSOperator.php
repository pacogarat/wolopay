 ...
 */
class SMSOperator extends \AppBundle\Entity\SMSOperator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SMSOperator' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\SMSOperator' . "\0" . 'country', '' . "\0" . 'AppBundle\\Entity\\SMSOperator' . "\0" . 'imgIcon', '' . "\0" . 'AppBundle\\Entity\\SMSOperator' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\SMSOperator' . "\0" . 'shortName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SMSOperator $proxy) {
