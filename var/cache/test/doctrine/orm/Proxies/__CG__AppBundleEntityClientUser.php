...
class ClientUser extends \AppBundle\Entity\ClientUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'client', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'clientUserHasApps', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'language', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'country', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'name', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function setValuesOnCloneManually()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValuesOnCloneManually', []);

        return parent::setValuesOnCloneManually();
    }
    ...
    public function getClientUserHasApps()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClientUserHasApps', []);

        return parent::getClientUserHasApps();
    }

    /**
     * {@inheritDoc}
     */
    public function setClientUserHasApps($clientUserHasApps = array (
))
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClientUserHasApps', [$clientUserHasApps]);

        return parent::setClientUserHasApps($clientUserHasApps);
    }
    ...
    public function addClientUserHasApp(\AppBundle\Entity\ClientUserHasApp $clientUserHasApp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addClientUserHasApp', [$clientUserHasApp]);

        return parent::addClientUserHasApp($clientUserHasApp);
    }
    ...
    public function removeClientUserHasApp(\AppBundle\Entity\ClientUserHasApp $clientUserHasApp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeClientUserHasApp', [$clientUserHasApp]);

        return parent::removeClientUserHasApp($clientUserHasApp);
    }

    /**
     * {@inheritDoc}
     */
    public function getRoleAdminFromApp(\AppBundle\Entity\App $app)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoleAdminFromApp', [$app]);

        return parent::getRoleAdminFromApp($app);
    }

    /**
     * {@inheritDoc}
     */
    public function getRolesAdmin(\AppBundle\Entity\App $app)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRolesAdmin', [$app]);

        return parent::getRolesAdmin($app);
    }
    ...
    public function getAllApps()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllApps', []);

        return parent::getAllApps();
    }

    /**
     * {@inheritDoc}
     */
    public function hasApp(\AppBundle\Entity\App $app)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasApp', [$app]);

        return parent::hasApp($app);
    }
    ...
    public function getTimeOffsetInHours()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTimeOffsetInHours', []);

        return parent::getTimeOffsetInHours();
    }
