 ...
 */
class Voice extends \AppBundle\Entity\Voice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'payMethodProviderHasCountry', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'number', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'amount', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'callMaxDuration', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'callLegalDuration', '' . "\0" . 'AppBundle\\Entity\\Voice' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Voice $proxy) {
    ...
    public function setCallMaxDuration($callMaxDuration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCallMaxDuration', [$callMaxDuration]);

        return parent::setCallMaxDuration($callMaxDuration);
    }
    ...
    public function getCallMaxDuration()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCallMaxDuration', []);

        return parent::getCallMaxDuration();
    }
    ...
    public function setCallLegalDuration($callLegalDuration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCallLegalDuration', [$callLegalDuration]);

        return parent::setCallLegalDuration($callLegalDuration);
    }
    ...
    public function getCallLegalDuration()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCallLegalDuration', []);

        return parent::getCallLegalDuration();
    }
