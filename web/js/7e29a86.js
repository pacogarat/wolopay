...
shopApp.config(['$logProvider', '$httpProvider', '$interpolateProvider', '$translateProvider', function($logProvider, $httpProvider, $interpolateProvider, $translateProvider){
    ...
    .run(['$rootScope', 'Device', '$log', function($rootScope, Device, $log){
        ...
        $log.debug("Device "+($rootScope.device.hasMouse ? 'Deskstop' : 'Mobile') + " pep " + Device.isBigScreen()+Device.hasMouse());

}]);


angular.module('shopApp').controller('ActionsCtrl', ['$rootScope', '$scope', 'routing', 'pageTransition', 'alerts', '$http', function ($rootScope, $scope, routing, pageTransition, alerts, $http) {
...
angular.module('shopApp').controller('MenuListCtrl', [ '$log', '$scope', '$rootScope', '$translate', 'APIArticleTab', 'APIAppShopHasArticles', 'resetVars', 'APIArticlePMPCA',
    function ($log, $scope, $rootScope, $translate, APIArticleTab, APIAppShopHasArticles, resetVars, APIArticlePMPCA) {
...
angular.module('shopApp').controller('RegisterCashCtrl', ['$scope', '$log',
    function ($scope, $log) {
...
angular.module('shopApp').controller('SMSOperatorsCtrl', [ '$rootScope', '$scope', 'routing', 'APISMSOperator',
    function ($rootScope, $scope, routing, APISMSOperator) {
