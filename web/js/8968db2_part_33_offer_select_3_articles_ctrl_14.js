smartApp.controller('OfferSelectArticlesController', ['$scope', '$rootScope', 'APIArticles', 'Utils', '$translate', 'APIAppShopHasArticles',
    function ($scope, $rootScope, APIArticles, Utils, $translate, APIAppShopHasArticles) {
    ...
    APIArticles.getByAppIdAndShopsAndCountries($rootScope.app.id, Utils.getCSVFromSelectedObjectsId($rootScope.offerCurrent.app_shops),
            Utils.getCSVFromSelectedObjectsId($rootScope.offerCurrent.countries), $translate.currentLang.langCode)
