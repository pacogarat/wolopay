smartApp.controller('OfferContainerCtrl', [ '$rootScope', '$location', '$scope', 'APIOffers', 'Utils',  'alerts', 'localize', '$routeParams', '$filter',
    function ($rootScope, $location, $scope, APIOffers, Utils,  alerts, localize, $routeParams, $filter) {
