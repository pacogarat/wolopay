smartApp.controller('ConfiguratorSelectLanguageController', ['$scope', 'APILanguages', '$rootScope', 'Watchers',
    function ($scope, APILanguages, $rootScope, Watchers) {

        Watchers.formIsDirty('form_language', $scope, function(){ $rootScope.configuratorCurrent.dirty = 1 });
