smartApp.controller('AnalyticsTransactionsPurchasesController', ['APIStats', '$scope', '$rootScope', '$log', 'Sparkline', 'Flot', 'localize', '$timeout',
    function (APIStats, $scope, $rootScope, $log, Sparkline, Flot, localize, $timeout) {
        ...
        function exe()
        {
            ...
            APIStats.getByApp().success(function (data){
                ...
                {
                    xAsis = {
                        categories: Flot.getKeys(data.amounts_game_single_payments_without_offer,'','H')
                    };
                }else{
                    xAsis = {
                        type: 'datetime' ,
                        dateTimeLabelFormats: { // don't display the dummy year
                            month: $scope.dateFormat == 'weeks' ? 'Week %W TOMATO': '%e. %b POTATO',
                            year: '%b'
                        }
                    };
                }
