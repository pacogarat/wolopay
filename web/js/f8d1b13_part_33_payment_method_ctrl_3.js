smartApp.controller('PaymentMethodController', ['APIStats', '$scope', '$rootScope', '$log', 'Sparkline', 'Flot', '$translate', '$timeout',
    function (APIStats, $scope, $rootScope, $log, Sparkline, Flot, $translate, $timeout) {
        ...
        $translate(['revenue', 'transactions', 'purchases', 'game_amount', 'unknown'
                ...
                APIStats.getPaymentMethods().success(function (data){
                    ...
                    angular.forEach(data.table_without_date, function(collection) {
                        if (!collection.country)
                            collection.country = translations['unknown'];
                    });
                        ...
                        series.push(
                            {
                                ...
                                stacking: 'normal',
                                tooltip: { valueSuffix: $rootScope.currency.symbol },
                                name: translations['revenue']+' '+payMethod,
                                color: Flot.increaseBrightness(Flot.getColors()[i++], 10),
