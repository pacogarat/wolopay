smartApp.controller('ActiveSubscriptionsController', ['$scope', 'APISubscription', '$modal', '$rootScope', '$routeParams', '$filter', 'LoadMoreScroll',
    function ($scope, APISubscription, $modal, $rootScope, $routeParams, $filter, LoadMoreScroll) {
        ...
        function exe(){
            APISubscription.getActives(
                ...
                if (data.length > 0)
                {
                    ...
                    $scope.subscriptions_country = $filter('unique')($scope.subscriptions, 'payment_detail.country.name');
                ...
                if (data.length == 0)
                {
                    ...
                    loadMoreScrollHandler = LoadMoreScroll.onScroll(function(){ exe(); });
                }
