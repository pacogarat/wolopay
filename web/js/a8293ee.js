...
var Routing={"payment_begin":"\/shop\/payment\/begin\/{transaction_id}\/{_locale}\/{pmpc_id}\/{article_ids}\/{country}","feed_back":"\/shop\/{transaction_id}\/feedback","gamer_update_data":"\/shop\/{transaction_id}\/{_locale}\/gamer-update-data","support_gamer":"\/shop\/support\/{_locale}\/{transaction_id}","api_default_get_test":"\/api\/v1\/test.{_format}","api_default_get_test_param_converter":"\/api\/v1\/tests\/{country}\/param\/converter.{_format}","api_country_get_countries":"\/api\/v1\/country.{_format}","api_article_get_articles":"\/api\/v1\/article.{_format}","api_article_get_articles_by_country":"\/api\/v1\/articles\/country\/{country}.{_format}","api_article_get_calculate_price_shopping_cart":"\/api\/v1\/calculate_price_cart\/{transaction_id}\/{country}\/{articles_ids}.{_format}","api_article_tab_get_tabs":"\/api\/v1\/tab.{_format}","api_pay_method_get_pay_methods_with_amount_fixed":"\/api\/v1\/paymethod\/amount-fixed.{_format}","api_pay_method_get_pay_methods":"\/api\/v1\/paymethod.{_format}","api_transaction_create_transaction":"\/api\/v1\/transaction.{_format}","api_transaction_create_transaction_custom":"\/api\/v1\/transaction_simple.{_format}","api_transaction_create_transaction_custom_widget":"\/api\/v1\/transaction_widget.{_format}","api_transaction_get_transaction":"\/api\/v1\/transaction\/{transaction_id}.{_format}","api_transaction_get_transaction_info":"\/api\/v1\/transaction_info\/{transaction_id}.{_format}","api_transaction_post_virtual_currency_exchange":"\/api\/v1\/virtual_currency\/exchange.{_format}","update_gacha_notification":"\/api\/v1\/trans3action\/{transaction_id}\/notification\/pdahga\/{pdahga_id}.{_format}","get_notification":"\/api\/v1\/transaction\/notification\/{notification_id}.{_format}","api_promo_code_is_valid":"\/api\/v1\/promo_code\/check\/gamer\/{gamer_id}\/promo_code\/{promo_code}.{_format}","api_promo_code_create_promo":"\/api\/v1\/promo_code.{_format}","api_promo_code_create_a_purchase_by_promo":"\/api\/v1\/promo_code\/use.{_format}","api_promo_code_update_promo":"\/api\/v1\/promo_code\/{promo_code}.{_format}","api_gamer_post_gamer":"\/api\/v1\/gamer.{_format}","api_gamer_patch_gamer":"\/api\/v1\/gamer\/{gamer_id}.{_format}","item_tab_get_item_tabs":"\/api\/v1\/item_tab.{_format}","translations_shop_common":"\/translations\/shop\/{domainName}\/{language}.json","facebook_products_info":"\/external-stores\/facebook\/product_info\/{article_id}\/{level_category_id}\/{country}"};
