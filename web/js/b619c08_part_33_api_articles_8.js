smartApp.factory('APIArticles' , ['$http', '$rootScope', function ($http, $rootScope) {
    return {
        ...
        getArticleByAppId: function (appId, pmpc, active, appShopFilter){
            pmpc = pmpc || '';
            appShopFilter = appShopFilter || '';
            active = (active ? '&active=1' : '');
            return $http.get('/admin/api/article/app/'+appId+'?app_shop_has_article_filtered='+appShopFilter+'&pmpc='+pmpc + active);
        },
