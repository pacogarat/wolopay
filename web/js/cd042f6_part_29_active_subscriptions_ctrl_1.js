smartApp.controller('ActiveSubscriptionsController', ['$scope', 'APISubscription', '$modal', '$rootScope', '$routeParams',
    function ($scope, APISubscription, $modal, $rootScope, $routeParams) {
