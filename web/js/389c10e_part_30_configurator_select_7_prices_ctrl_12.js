smartApp.controller('ConfiguratorSelectPricesController', ['APIAppShopHasArticles', 'APIAppShops', 'APICountries', 'APIArticles', 'APIPayMethods', '$scope', 'Utils', '$rootScope', '$http', 'Watchers', '$log', '$filter',
    function (APIAppShopHasArticles, APIAppShops, APICountries, APIArticles, APIPayMethods, $scope, Utils, $rootScope, $http, Watchers, $log, $filter) {
    ...
    //                    console.log("FFF", appShop, country.id, appShopHasArticle, article);
                        ...
                        if (article.amount_standard === 0)
                        {
                            ...
                            if ((!$scope.ignoreCostOfLife && !typeForce) || typeForce == 'costOfLive')
                            {
