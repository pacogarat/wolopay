smartApp.controller('ConfiguratorSelectArticlesAndShopsController', ['APIAppShops', 'APILanguages', 'APIShopTemplates', 'APIArticles', 'APIPayMethods', '$scope', 'Utils', '$rootScope', 'APIAppTabs', 'APIAppShopHasAppTabs', '$filter', 'APIArticleCategories', 'APIPayCategories', '$modal', '$http', 'Watchers',
    function (APIAppShops, APILanguages, APIShopTemplates, APIArticles, APIPayMethods, $scope, Utils, $rootScope, APIAppTabs, APIAppShopHasAppTabs, $filter, APIArticleCategories, APIPayCategories, $modal, $http, Watchers) {
