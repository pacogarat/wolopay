...
'use strict';
var shopApp = angular.module('shopApp', ['pascalprecht.translate', 'localytics.directives', 'ngAnimate']);
...
shopApp.controller('ActionsCtrl', function ($rootScope, $scope, routing, pageTransition, alerts, $http) {
...
shopApp.controller('ArticleTabCtrl', function (APIArticleTab, APIAppShopHasArticles, APIArticlePMPCA, APICountry, $scope, $rootScope, resetVars, $log, alerts) {
