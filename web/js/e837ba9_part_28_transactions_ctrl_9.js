smartApp.controller('TransactionsController', ['$scope', 'APITransactions', '$rootScope', '$routeParams', 'CommonFTransPurchNot', '$filter',
    function ($scope, APITransactions, $rootScope, $routeParams, CommonFTransPurchNot, $filter) {
