smartApp.controller('ProjectConfigureController', ['$scope', '$routeParams', 'APIApps', '$rootScope', 'APICountries', '$filter', 'alerts',
    function ($scope, $routeParams, APIApps, $rootScope, APICountries, $filter, alerts) {
