smartApp.controller('ConfiguratorSelectPayMethodsController', [ '$scope', 'APICountries', 'APIPayMethods', '$rootScope', 'Utils', 'filterFilter', '$http', 'Watchers',
    function ($scope, APICountries, APIPayMethods, $rootScope, Utils, filterFilter, $http, Watchers) {

        Watchers.formIsDirty('form_pay_methods', $scope, function(){ $rootScope.configuratorCurrent.dirty = 1 });
        ...
        $scope.selectAll = function ()
        {
            ...
            $scope.form_pay_methods.$setDirty(true);
        };
