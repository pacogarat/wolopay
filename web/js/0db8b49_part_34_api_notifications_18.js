smartApp.factory('APINotifications' , ['$http', '$rootScope', 'RowsCalculator', function ($http, $rootScope, RowsCalculator) {
    return {
            ...
            ,gamerExternalIdFilter, wasReceivedFilter, subscriptionIdFilter)
        {
            ...
            return $http.get('/admin/api/app/'+appId+'/notifications/'+dateFrom+'/'+dateTo+'/'+currencyId+'?page='+page+
                ...
                '&gamer_external_id='+gamerExternalIdFilter+'&was_received='+wasReceivedFilter+'&subscription_id='+subscriptionIdFilter+'&rows='+RowsCalculator.getByScreenHeight()
            );
        },
