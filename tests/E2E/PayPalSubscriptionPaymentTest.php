...
use AppBundle\Tests\E2E\PageActions\PayMethod\PayPalSubscriptionPage;

class PayPalSubscriptionPaymentTest extends AbstractE2EShop
{
    /**
     * @group E2E
     * @group Selenium
    ...
    public function testOK()
    {
        ...
        $paypal = new PayPalSubscriptionPage($this->driver);
        $paypal
