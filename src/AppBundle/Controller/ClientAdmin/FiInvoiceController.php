 ...
 * @Route("/api/invoices")
 */
class FiInvoiceController extends Controller
{
    /**
     * @var Serializer
    ...
    /**
     * @Route("/", name="admin_invoices_merchant")
     */
    public function getInvoices(Request $request)
    {
        ...
        $finInvoices = $this->em->getRepository("AppBundle:FinInvoice")->findOnlyValidByClientId(
