smartApp.controller('PurchasesController', ['$scope', 'APIPurchases', '$modal', '$rootScope', '$filter', '$routeParams', 'CommonFTransPurchNot', 'LoadMoreScroll', '$http',
    function ($scope, APIPurchases, $modal, $rootScope, $filter, $routeParams, CommonFTransPurchNot, LoadMoreScroll,http) {
