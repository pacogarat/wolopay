...
//        console.log(toSlideId, "wrapper width", that.wrapperInnerWidth, "totalWidth", that.totalWidth, "Items per screen", itemsPerScreen, "item width", that.itemsWidth, "margin per item", that.marginPerItem);
    };
