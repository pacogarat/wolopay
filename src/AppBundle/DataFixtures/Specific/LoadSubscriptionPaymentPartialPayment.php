...
class LoadSubscriptionPaymentPartialPayment extends AbstractLoadPayment implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        // this subscriptionEventuality is completed when it have two payments
        ...
        $subscription
            ...
            ->setAmountForEachPayment(($appShopHasArticle->getAmount()/2) + 0.1 )
            ->setAmountForEachPaymentToComplete($appShopHasArticle->getAmount())
        ...
        $this->createPaymentDetails($subscription, [$pda], $appShopHasArticle->getAmount(), $pmpc);
