...
/**
 * @Service("shop.payment.steam_web_ipn_pay_method")
 *
 * Steam user: wolopay
 *
 * Api documentation
 ...
 */
class SteamWebIpnPayMethod extends SteamPayMethod implements PreviousStepInterface, PayMethodIpnExecutionInterface,
    PayMethodRefundExecutionInterface
{

    public function executePaymentPrepare(PaymentPrepareInteract $paymentInteract)
    {
        $this->container->get('logger')->addInfo("executePaymentPrepare for Steam WEB");
        $this->executePaymentPrepareReal($paymentInteract, true);
    }
}